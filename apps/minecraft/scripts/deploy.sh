...
mkdir -p "${HOME}/minecraft/modded"
mkdir -p "${HOME}/minecraft/insane"
...
echo "  systemctl --user start minecraft-modded.service"
echo "  systemctl --user start minecraft-insane.service"
echo ""
echo "Verify:"
